...
- Program to check whether a given number is a natural number and find the sum of first n natural numbers.
...
- Program to calculate the sum of n natural numbers using a while loop and verify it with the formula n × (n + 1) / 2.
- Program to calculate the sum of n natural numbers using a for loop and verify it with the formula.
